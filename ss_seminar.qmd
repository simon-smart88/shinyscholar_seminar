...
## Add diagram of shinyscholar modules? 
...
token <- {{select_token}}
ras <- select_query(poly, {{select_date}}, token)
...
```{r eval = FALSE, echo = TRUE}
#```{r}
poly <- matrix(c(-1.54202000000001, -1.54202000000001, -0.718278999999995, -0.718278999999995, -1.54202000000001, 52.509368, 52.789309, 52.789309, 52.509368, 52.509368), ncol = 2, byrow = FALSE)
token <- NULL
ras <- select_async(poly, "2024-10-09", token)$raster
raster_name <- "FAPAR"
...
## Disaggregation regression enables high resolution

## There are several types of data to process

![](images/disag_data_types_path.svg)

## Components and module in disagapp
...
::: {.column width="50%"}
<img src="images/wellcome_logo.png" width="300">
<img src="images/wallace_logo.png" width="400">
:::
:::
